...
class Login {
    ...
    refreshAndSid = async (error) => {
        ...
        const redirectResp = await this.request.get(`${REDIRECT_ENDPOINT}?redirectUrl=${STORE_HOMEPAGE}&clientId=${EPIC_CLIENT_ID}`, {
            headers: {
                'x-xsrf-token': csrfToken,
            },
            searchParams: redirectSearchParams,
        });
        console.log(`get url ${REDIRECT_ENDPOINT}?redirectUrl=${STORE_HOMEPAGE}&clientId=${EPIC_CLIENT_ID}`);
        console.log("get cookie " + this.request.get)
